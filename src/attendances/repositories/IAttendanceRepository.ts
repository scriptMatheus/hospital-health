...
interface IAttendanceRepository {
    ...
    findByProfessionalAndDateTime(professionalId: string, attendanceDate: string, attendanceTime: string, excludeAttendanceId: string | null, conSource: DataSource): Promise<Attendance|null>;
